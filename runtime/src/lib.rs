...
impl<N: Get<u128>> ConversionFromAssetBalance<u128, (), u128> for MulBy<N> {
	type Error = ();
	fn from_asset_balance(balance: u128, _asset_id: ()) -> Result<u128, Self::Error> {
...
mod benches {
	...
	>>>>>>> feature/update-for-async-backing
		);
}
